...
-- | --
`sensor` | Show info from aps API.

## Installation

or click: [![添加集成](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start?domain=aps_monitor)
